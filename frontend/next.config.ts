...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "img-src 'self' data: blob: https://img.clerk.com https://images.unsplash.com https://*.yahoo.com https://*.yimg.com",
      "connect-src 'self' https://*.clerk.accounts.dev https://query1.finance.yahoo.com https://query2.finance.yahoo.com wss: ws:",
